...
namespace AutomobileWinApp
{
    public partial class frmCarManagement : Form
    {
        ...
        private void frmCarManagement_Load(object sender, EventArgs e)
        {
            ...
            dgvCarList.CellDoubleClick += dgvCarList_DoubleClick;
            Car car = CarDBContext.Instance.GetCarByID(2);
        ...
        public void LoadCarList()
        {
            ...
            try
            {
                ...
                txtManufacturer.DataBindings.Add("Text", source, "Manufacturer"); // Corrected field name
